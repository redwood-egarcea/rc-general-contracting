/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: b51553fca095819c55353b1a26f3776c)
// Runtime types generated with workerd@1.20260921.1 2026-09-23 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	API_RATE_LIMITER: RateLimit;
	SUBMIT_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	PUBLIC_TURNSTILE_SITE_KEY: string;
	PUBLIC_TURNSTILE_REVEAL_SITE_KEY: string;
	PUBLIC_SITE_URL: string;
	PUBLIC_CLOUDFLARE_ANALYTICS_TOKEN: string;
	ALLOWED_HOSTNAMES: string;
	APP_ENV: string;
	TURNSTILE_SECRET_KEY: string;
	TURNSTILE_REVEAL_SECRET_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_TURNSTILE_SITE_KEY" | "PUBLIC_TURNSTILE_REVEAL_SITE_KEY" | "PUBLIC_SITE_URL" | "PUBLIC_CLOUDFLARE_ANALYTICS_TOKEN" | "ALLOWED_HOSTNAMES" | "APP_ENV" | "TURNSTILE_SECRET_KEY" | "TURNSTILE_REVEAL_SECRET_KEY" | "CONTACT_EMAIL" | "CONTACT_PHONE" | "FORM_DESTINATION" | "EMAIL_FROM">> {}
}
